 ...
 * نسخه 5 سربرگ و اقلام Invoice را اضافه کرد.
 * نسخه 6 جدول مقادیر Dynamic Attribute کالا را اضافه می‌کند.
 *
 * تمام Migrationها افزایشی هستند و داده‌های نسخه‌های قبلی حذف نمی‌شوند.
 */
@Database(
    entities = [
        ProductEntity::class,
